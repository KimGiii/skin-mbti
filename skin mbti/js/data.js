...
const infoList = [
  ...
  },
  {
    ...
    context : '<관리방법> OSNW피부 타입은 피지 분비량을 조절하기 위해서 보통 많이 사용하는 각질제거제인 BHA를 사용할 수 있습니다. 하지만, 잦은 사용으로 인해 피부를 더 민감하고 피부 트러블을 더 만들 수 있기 때문에 적정량의 사용을 권합니다. 피부 트러블이 심각하면 아다팔렌성분이 함유된 디페린 또는 벤조일퍼옥사이드성분이 함유된 제품을 사용할 수 있습니다. 이 제품은 각각 사용할 수도 있으며 같이 사용할 수 있습니다. 단, 두 제품 모두 피부자극이 있습니다. 만약, 벤조일과 디페린 성분으로 피부트러블이 해결되지 않는다면, 먹는 약 이소티논을 의사에게 처방받아 먹어야합니다. 주름을 예방하기 위해 자외선차단제 사용이 좋지만, 피부트러블에게 있어서는 해가 될 수 있기 때문에 적절한 균형이 필요합니다. '
  },
  {
    name: '<OSNT>',
